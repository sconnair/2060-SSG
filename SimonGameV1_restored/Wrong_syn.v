...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="WRO1" LPM_CVALUE=00C65D40 LPM_WIDTH=32 result
...
module  Wrong_lpm_constant
	...
	defparam
		mgl_prim1.cvalue = 32'b00000000110001100101110101000000,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1465012017,
...
module Wrong (
	...
	Wrong_lpm_constant	Wrong_lpm_constant_component (
				.result (sub_wire0));
