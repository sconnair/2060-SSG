...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="YEL1" LPM_CVALUE=017A3284 LPM_WIDTH=32 result
...
module  YELLOW_lpm_constant
	...
	defparam
		mgl_prim1.cvalue = 32'b00000001011110100011001010000100,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1497713713,
...
module YELLOW (
	...
	YELLOW_lpm_constant	YELLOW_lpm_constant_component (
				.result (sub_wire0));
