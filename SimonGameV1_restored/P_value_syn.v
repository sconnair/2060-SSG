...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="CON1" LPM_CVALUE=01111111 LPM_WIDTH=32 result
...
module  P_value_lpm_constant
	...
	defparam
		mgl_prim1.cvalue = 32'b00000001000100010001000100010001,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1129270833,
...
endmodule //P_value_lpm_constant
//VALID FILE
...
module P_value (
	...
	P_value_lpm_constant	P_value_lpm_constant_component (
				.result (sub_wire0));
