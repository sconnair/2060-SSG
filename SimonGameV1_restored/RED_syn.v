...
//lpm_constant ENABLE_RUNTIME_MOD="YES" INSTANCE_NAME="RED1" LPM_CVALUE=01DC8057 LPM_WIDTH=32 result
...
module  RED_lpm_constant
	...
	defparam
		mgl_prim1.cvalue = 32'b00000001110111001000000001010111,
		mgl_prim1.is_data_in_ram = 0,
		mgl_prim1.is_readable = 0,
		mgl_prim1.node_name = 1380271153,
...
module RED (
	...
	RED_lpm_constant	RED_lpm_constant_component (
				.result (sub_wire0));
